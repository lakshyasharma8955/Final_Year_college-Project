...
//                 <div className="flex justify-between items-start sm:pr-5">
//                     <Link to={`/product/${product}`} className="flex flex-col gap-0.5">
//                         <p className="group-hover:text-primary-blue w-56 sm:w-full text-lg font-medium">{name.length > 85 ? `${name.substring(0, 85)}...` : name}</p>
//                         {/* <!-- rating badge --> */}
//                         <span className="text-sm text-gray-500 font-medium flex gap-2 items-center">
...
//                         {/* <!-- rating badge --> */}
//                     </Link>
//                     <button onClick={deleteHandler} className="text-gray-400 hover:text-red-500"><span><DeleteIcon sx={{ fontSize: "18px" }} /></span></button>
//                 </div>
//                 {/* <!-- product title --> */}

//                 {/* <!-- price desc --> */}
//                 <div className="flex items-center gap-2 text-2xl font-medium">
//                     <span className="text-primary-green">₹{price.toLocaleString()}</span>
//                     <span className="text-sm text-gray-500 line-through font-normal mt-1">₹{cuttedPrice.toLocaleString()}</span>
//                     <span className="text-sm text-primary-green mt-1">{getDiscount(price, cuttedPrice)}% off</span>
//                 </div>
//                 {/* <!-- price desc --> */}
