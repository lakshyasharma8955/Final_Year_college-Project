...
const Register = () => {
    ...
    return (
        <>
            <MetaData title="Register | Rajasthan Villa" />

            {loading && <BackdropLoader />}
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">

                {/* <!-- row --> */}
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg border-8">

                    <FormSidebar
                        title="Welcome to our platform!"
                        tag="Join us today and get started by signing up with your mobile number!"
                    />
