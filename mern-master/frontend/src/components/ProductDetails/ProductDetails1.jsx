        ...
        <>
            {loading ? <Loader /> : (
                <>
                    ...
                    <MinCategory />
                    <main className="mt-12 sm:mt-0  font-medium">
                            ...
                            <div className="w-full sm:w-2/5 sm:sticky top-16 sm:h-screen shadow-md shadow-gray-500">
                                ...
                                <div className="flex flex-col gap-3 m-3">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-green-400 rounded-lg shadow hover:shadow-lg">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={product.stock < 1 ? "p-4 w-full flex items-center justify-center gap-2 text-white bg-red-600 cursor-not-allowed rounded-lg shadow hover:shadow-lg" : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-pink-600 rounded-lg shadow hover:shadow-lg"}>
                                            <FlashOnIcon />
                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <span className="text-sm text-black-500 font-medium flex gap-2 items-center ">
                                        <span className="text-sm px-1.5 py-0.5 bg-primary-orange rounded-sm text-white flex items-center gap-0.5">{product.ratings && product.ratings.toFixed(1)} <StarIcon sx={{ fontSize: "12px" }} /></span>
                                    ...
                                    {/* <!-- banks offers --> */}
                                    <p className="text-md font-medium text-primary-green">Available offers</p>
                                   
                                 
                                        <p className="text-sm flex items-center gap-1">
                                            {/* <span className="text-primary-lightGreen"><LocalOfferIcon sx={{ fontSize: "20px" }} /></span> */}
                                            <span className="font-medium ml-2 text-primary-green">Offer</span> Free shipping on orders of 500 and above 
                                        </p>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                ...
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-red-500"><CachedIcon sx={{ fontSize: "18px" }} /></span> 7 Days Replacement Policy</p>
                                                </li>
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-red-500"><CurrencyRupeeIcon sx={{ fontSize: "18px" }} /></span> Cash on Delivery available</p>
                                                </li>
                                            </ul>
                                        </div>
                                        {/* <!-- services details --> */}
                                    ...
                                    <div className="flex gap-16 mt-4 items-center text-sm font-medium">
                                        ...
                                        <p className="font-medium  ml-3" to="/">{product.brand && product.brand.name}</p>
                                    </div>
                                    {/* <!-- seller details --> */}
                                    ...
                                    {/* <!-- border box --> */}
                                    <div className="w-full mt-6 rounded-sm border flex flex-col shadow-sm shadow-gray-500">
                                    ...
                                    <div className="w-full mt-4 pb-4 rounded-sm border flex flex-col shadow-sm shadow-gray-500">
                                    ...
                                    {/* <!-- reviews border box --> */}
                                    <div className="w-full mt-4 rounded-sm border flex flex-col shadow-sm shadow-gray-500">
                                        <div className="flex justify-between items-center border-b px-6 py-4">
                                            <h1 className="text-2xl font-medium">Ratings & Reviews</h1>
                                            <button onClick={handleDialogClose} className="shadow bg-red-400 text-white px-4 py-2 rounded-sm hover:shadow-lg">Rate Product</button>
                                        </div>
